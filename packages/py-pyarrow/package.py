...
class PyPyarrow(PythonPackage, CudaPackage):
    ...
    version("12.0.0", sha256="19c812d303610ab5d664b7b1de4051ae23565f9f94d04cbea9e50569746ae1ee")
    ...
    variant("snappy", default=False, description="Build with Snappy support")
    ...
    depends_on("py-cython@0.29.33", type="build", when="@12.0.0:")
    #depends_on("py-cython@3.0.0a9:", type="build", when="@12.0.0:") #EO
    depends_on("py-numpy@1.14:", type=("build", "run"), when="@0.15.0:")
    depends_on("py-numpy@1.16.6:", type=("build", "run"), when="@3.0.0:")
    #EO ? depends_on("thrift", type=("build", "run"))
    ...
    for v in arrow_versions:
        ...
        depends_on("arrow+snappy" + v, when="+snappy" + v)
