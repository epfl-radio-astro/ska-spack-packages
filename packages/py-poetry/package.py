...
class PyPoetry(PythonPackage):
    ...
    version("1.2.2", sha256="6d9ed0b1b826a0a79190f2078d7d78483fa24bf2494f3b170e354eaa5e7b5ea1")
    ...
    depends_on("py-poetry-core@1.3.2", when="@1.2.2:", type=("build", "run"))
    ...
    depends_on("py-poetry-plugin-export@1.1.2", when="@1.2.2:", type=("build", "run"))
    depends_on(
